                ...
                <>
                    <div className="layout__container layout__container_indent-h_s">
                        <div className="section section_underline_grey section_indent-t_10">
                            <div
                                className="text text_size_s text_line_m text_weight_bold section__selected-item tab">DETAILS
                            </div>
                            <div
                                onClick={this.changeToHistory}
                                className="text text_size_s text_line_m text_weight_bold text_indent-l_30 text_color_grey tab">HISTORY
                            </div>
                        </div>
                    </div>
                    <div>
