    ...
    render() {
        return (
            <div className="list__container">
                <div
                    onClick={this.open}
                    className="list__item list__name">
                    <div className={this.getIcon()}/>
                    <div>{this.props.file.name}</div>
                </div>
                <div className="list__item list__brunch">{this.props.file.branch}:</div>
                <div className="list__item list__hash">{this.props.file.sha.substring(0,5)}</div>
                <div className="list__item list__message">{this.getMessage()}</div>
                <br className="list__break"/>
                <div className="list__item list__hash-mob">{this.props.file.sha.substring(0,5)}</div>
                <div className="list__item list__author-mob">, by {this.props.file.author},</div>
                <div className="list__item list__author nickname">{this.props.file.author}</div>
