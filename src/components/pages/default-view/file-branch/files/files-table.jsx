                ...
                <>
                    <div className="layout__container layout__container_indent-h_s">
                        <div className="section section_underline_grey section_indent-t_10">
                            <div className="text text_size_s text_line_m text_weight_bold section__selected-item tab">FILES
                            </div>
                            <div
                                onClick={this.changeToBranches}
                                className="text text_size_s text_line_m text_weight_bold text_color_grey text_indent-l_30 tab">BRANCHES
                            </div>
                        </div>
